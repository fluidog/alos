...
#include <types.h>
s8 fat_load_file(void *loadAddr,char *fileName);
 ...
 *
 * Note: FAT buffer0 has to be 32 bit aligned
 * (see FAT32 accesses)
 */
typedef struct {
	__u8	fatbuf[SECTORSIZE*2]; /* Current FAT buffer0 */
	int		fatsize;	/* Size of FAT in bits */
	__u16	fatlength;	/* Length of FAT in sectors */
	__u16	fat_begin;	/* Starting sector of the FAT */
	__u16	rootdir_begin;	/* Start sector of root directory */
