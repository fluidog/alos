...
#define VGA_PHY_BASE 	0xb8000	//显存起始物理地址
#define VGA_PHY_END 	0xA0000	//显存结束物理地址
#define VGA_BASE		(VGA_PHY_BASE+VM_START)	//显存起始
#define VGA_END			(VGA_PHY_END+VM_START)//显存末尾
