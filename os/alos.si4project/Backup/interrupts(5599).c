...
asm(".text\n .global keyboard_interrupt\n"
	...
	"mov $0x20,%al\n" /*发送非特指EOI，结束中断*/
	"out %al,$0x20\n"
	"xor %eax,%eax\n"	//必须清零，否则有可能会在call key_table[i]出错
	"in $0x60,%al\n"	//扫描码,未清零，这个bug很难找
	"push %eax\n"
