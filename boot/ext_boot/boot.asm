%include "pm.inc"
org 7c00H
__start:		;将load.bin加载到es:0处,即0x10000	
	mov ax,cs	;位于相同段
	mov ss,ax
	mov ds,ax
	mov ax,0x1000	
...
Loadfile:
	...
	mov ax,[es:di+8]	;第一个group的结点表的块号
...
bg_inode_table dw 0
load_addr dw 0		;0x1000:0x00  0x10000处
i_zone  times 12 dd 0 	;i_zone[0]~i_zone[11] 最多表示12block
